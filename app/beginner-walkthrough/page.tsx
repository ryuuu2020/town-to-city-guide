        ...
        <div className="flex-1 lg:max-w-[65%] space-y-10">
          ...
          <section>
            ...
            <p className="text-ink-light leading-relaxed mb-4">
              ...
              and <strong className="text-ink">River</strong> access. Avoid Mountain or Desert maps, since
          ...
          <section>
            ...
            <ul className="list-decimal list-inside space-y-3 text-ink-light text-sm">
              ...
              <li><strong className="text-ink">Neglecting citizen happiness.</strong> Low happiness reduces productivity by up to 30%. Place decorations (benches, flowers) in every residential area, since they are cheap and effective.</li>
