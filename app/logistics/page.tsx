...
export const metadata = {
  title: "Trade & Logistics Guide — Coming Soon | Town To City",
  description: "Trade & Logistics Guide is coming soon. We are working on a comprehensive guide for Town To City.",
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16 text-center">
      <div className="bg-parchment-light rounded-xl p-10 border border-border-subtle">
        ...
        <h1 className="font-display text-3xl text-ink mb-3">Trade & Logistics Guide</h1>
