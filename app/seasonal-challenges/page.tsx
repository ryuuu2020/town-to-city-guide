...
const seasonOverview = [
  {
    ...
    strategy: "Spring is the rebuilding season. Repair all winter-damaged buildings in the first 15 days. Plant wheat, vegetables, and cotton immediately. Reserve 20% of your workforce for repair and construction — do not overcommit to farming and leave buildings in disrepair.",
  },
  {
    ...
    strategy: "Summer is the production season. Maximize crop output — double harvest means every farm produces 2x. Build extra water storage (cisterns, wells) before the first heat wave. Unemployed citizens during heat waves become unhappy — assign them to shade-tolerant jobs or leisure buildings.",
  },
  {
...
const seasonalTips = [
  ...
  "Winter is not dead time — it is research and crafting time. Move unemployed farmers to research labs, workshops, and the university. The research you complete in winter powers next year's efficiency.",
  ...
  "Warm clothing is not optional luxury — citizens without warm clothing in winter have 3x sickness rate. Produce wool coats and leather boots in autumn. One coat per citizen is the minimum standard.",
