export const metadata = {
  ...
  title: { absolute: 'Town to City Defense Layouts: Walls and Fortifications' },
...
export default function DefenseLayoutPage() {
  ...
  const threatDefense = [
    ...
    { threat: "Dragon/Wyvern", wallEffectiveness: "Low: Bypasses ground walls", towerEffectiveness: "High: Scorpion bolts vs air", moatEffectiveness: "None: Flies over", recommendedLayout: "Anti-air ballista towers on high platforms" },
      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
        <div className="flex-1 lg:max-w-[65%] space-y-10">
          ...
          <section>
            ...
            <p className="text-ink-light leading-relaxed mb-4">
              Towers multiply your defensive firepower by granting increased attack range, line-of-sight bonuses, and specialized damage types. The three tower varieties in Town to City are:
            </p>
