      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
        <div className="flex-1 lg:max-w-[65%] space-y-10">
          ...
          <section>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Population growth comes from the station: new families arrive periodically and ask for housing. If you have vacant homes, food surplus, and happy citizens, they move in. If any of the three fails, arrivals decline or leave. This means population is a lagging indicator: you build capacity first, then citizens fill it. Planning an upgrade means building the housing, food production, and services for the next tier's population before the citizens arrive rather than after.
            </p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-100 mb-4">The Upgrade Rhythm</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
